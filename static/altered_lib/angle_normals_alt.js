// angle_normals.js
// A Require modification of::: https://github.com/mikolalysenko/angle-normals/blob/master/angle-normals.js
//
'use strict'
//define('angle_normals',[], function() {

let p_exports = {'angle_normals':'angle_normals'};
//module.exports = angleNormals

function hypot(x, y, z) {
  return Math.sqrt(Math.pow(x,2) + Math.pow(y,2) + Math.pow(z,2))
}
p_exports.hypot = hypot;

function weight(s, r, a) {
  return Math.atan2(r, (s - a))
}
p_exports.weight = weight;
...
p_exports.angleNormals = angleNormals;
exports = p_exports;
